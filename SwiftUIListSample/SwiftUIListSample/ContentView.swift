...
enum OperationsMenu: Int, CaseIterable, Identifiable {
    ...
    var title: String {
        ...
        case .accordion:
            return "Accordion"
        case .singleSelection1:
            return "Single Selection1"
        case .singleSelection2:
            return "Single Selection2"
        case .scrollToRow:
            return "Scroll To Row"
        }
    }
...
struct ContentView: View {
    ...
    private func containedView(menu: OperationsMenu) -> AnyView {
        ...
        case .singleSelection2:
            return AnyView(NavigationLink(destination: SingleSelection2View(title: menu.title)) { Text(menu.title) })
        case .scrollToRow:
            return AnyView(NavigationLink(destination: ScrollToRowView(title: menu.title)) { Text(menu.title) })
        }
    }
}
